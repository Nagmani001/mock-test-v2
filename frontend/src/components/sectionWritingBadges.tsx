...
export const SectionWritingBadge = React.memo(({ number }: { number: number }) => {
  const gradientId = `grad-section-success-${number}-${Math.random().toString(36).substr(2, 9)}`;
...
export const SectionWritingFailBadge = React.memo(
  ({ number }: { number: number }) => {
    const gradientId = `grad-section-fail-${number}-${Math.random().toString(36).substr(2, 9)}`;
...
export const SectionWritingMarkedBadge = React.memo(
  ({ number }: { number: number }) => {
    const gradientId = `grad-section-marked-${number}-${Math.random().toString(36).substr(2, 9)}`;
...
export const SectionWritingNotVisitedBadge = React.memo(
  ({ number }: { number: number }) => {
    const gradientId = `grad-section-not-visited-${number}-${Math.random().toString(36).substr(2, 9)}`;
...
export const SectionWritingAnsweredMarkedBadge = React.memo(
  ({ number }: { number: number }) => {
    const gradientId = `grad-section-answered-marked-${number}-${Math.random().toString(36).substr(2, 9)}`;
